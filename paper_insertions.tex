...
% [TBD] cells: fill Params via
%   python -c "from src.model import build_model; print(sum(p.numel() for p in build_model().parameters())/1e6)"
% and Time (h) + Epochs from the full-data training log.
% NOTE: trained on an NVIDIA RTX PRO 6000 (96 GB), unlike the V100/Titan XP rows.
% ---------------------------------------------------------------------
braingen\_CondDiffuser\_BraTS\_v1 & 1e--4 & AdamW & 32 & 20 & \textit{[TBD]} & \textit{[TBD]} & 89 \\
